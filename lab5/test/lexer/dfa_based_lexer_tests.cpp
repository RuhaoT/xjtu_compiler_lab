...
class DFABasedLexerTest : public ::testing::Test {
protected:
    ...
    static void SetUpTestSuite() {
        ...
        std::string log_filename = "dfa_based_lexer_tests.log";
        // init the logger
...
TEST_F(DFABasedLexerTest, DFABasedLexerTest_ConstructMinimalLexer_Test){
    spdlog::info("##### Entering DFABasedLexerTest_ConstructMinimalLexer_Test #####");
    std::string config_file = "test/data/lexer/dfa_based_lexer/minimal_correct_lexer_config.yml";
...
TEST_F(DFABasedLexerTest, DFABasedLexerTest_ParseStringToTokens_Test){
...
TEST_F(DFABasedLexerTest, DFABasedLexerTest_ParseFileToTokens_Test){
    spdlog::info("##### Entering DFABasedLexerTest_ParseFileToTokens_Test #####");
    std::string config_file = "test/data/lexer/dfa_based_lexer/sim_c_config.yml";
    // check if the file exist
    std::ifstream file(config_file);
    ASSERT_TRUE(file.good()) << "File " << config_file << " does not exist.";
