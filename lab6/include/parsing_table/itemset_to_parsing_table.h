...
public:
    ...
    lr_parsing_model::LRParsingTableGenerationResult generate_itemset_parsing_table_mapping();
    ...
    // get parsing table
    lr_parsing_model::LRParsingTableGenerationResult get_parsing_table() const
    {
